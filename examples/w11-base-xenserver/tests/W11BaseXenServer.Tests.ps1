# Pester 5 validation for the Windows 11 Enterprise XenServer base golden image.
...
Describe "Windows 11 XenServer base golden image" {
    ...
    Context "Guest tools" {
        It "has the XenServer / Citrix guest agent service present" {
            $svc = Get-Service -Name xenagent, XenSvc -ErrorAction SilentlyContinue
