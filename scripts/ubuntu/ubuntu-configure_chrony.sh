#!/bin/bash
#===================================================================================
# Script: configure_chrony_ubuntu.sh
# Description: Configure chrony time synchronization for Ubuntu
# Author: XOAP Infrastructure Team
# Usage: ./configure_chrony_ubuntu.sh [--ntp-servers "server1 server2"]
#===================================================================================
...
log_info "Starting chrony configuration for Ubuntu..."
...
cat > "$CHRONY_CONF" <<EOF
# Chrony configuration for Ubuntu
# Generated by configure_chrony_ubuntu.sh
...
log_info "Service status: $(systemctl is-active chrony)"
