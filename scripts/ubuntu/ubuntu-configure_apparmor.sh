#!/bin/bash
#===================================================================================
# Script: ubuntu-configure_apparmor.sh
# Description: Configure AppArmor security for Ubuntu
# Author: XOAP Infrastructure Team
# Usage: ./ubuntu-configure_apparmor.sh [--mode enforce|complain]
#===================================================================================
...
log_info "Starting AppArmor configuration for Ubuntu..."
...
if ! command -v aa-status &>/dev/null; then
    ...
    if DEBIAN_FRONTEND=noninteractive apt-get install -y apparmor apparmor-utils apparmor-profiles apparmor-profiles-extra; then
