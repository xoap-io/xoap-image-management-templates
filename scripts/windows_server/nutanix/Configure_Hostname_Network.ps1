...
function Stop-Logging {
    ...
    Write-Log "===== Configure_Hostname_Network complete in $([int]((Get-Date) - $script:startTime).TotalSeconds)s; exit=$ExitCode ====="
...
try {
    ...
    Write-Log "===== Configure_Hostname_Network starting ====="
