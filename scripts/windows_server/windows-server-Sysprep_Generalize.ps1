<#
.SYNOPSIS
    Performs final cleanup and prepares Windows Server for sysprep
...
.NOTES
    File Name      : windows-server-Sysprep_Generalize.ps1.ps1
...
.EXAMPLE
    .\windows-server-Sysprep_Generalize.ps1.ps1
    Performs final cleanup and sysprep preparation with generalize option
