<#
.SYNOPSIS
    Performs final cleanup and prepares Windows Server for sysprep with OOBE

.DESCRIPTION
    This script performs final cleanup tasks and prepares the system for sysprep and imaging on Windows Server.
    Developed and optimized for use with the XOAP Image Management module, but can be used independently.
    No liability is assumed for the function, use, or consequences of this freely available script.

.NOTES
    File Name      : windows-server-Final_Cleanup_Sysprep_oobe.ps1.ps1
...
.EXAMPLE
    .\windows-server-Final_Cleanup_Sysprep_oobe.ps1.ps1
    Performs final cleanup and sysprep preparation with OOBE option
