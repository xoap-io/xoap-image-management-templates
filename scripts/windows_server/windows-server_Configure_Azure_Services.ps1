...
.NOTES
    File Name      : windows-server_configure_Azure_Services.ps1
    Prerequisite   : PowerShell 5.1 or higher, Administrator privileges
    Copyright      : XOAP.io
    
.EXAMPLE
    .\windows-server_configure_Azure_Services.ps1
    Configures all Azure services with defaults
    
.EXAMPLE
    .\windows-server_configure_Azure_Services.ps1 -SkipArc
