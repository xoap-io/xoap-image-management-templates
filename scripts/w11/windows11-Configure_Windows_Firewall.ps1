...
.NOTES
    File Name      : windows11-configure_Windows_Firewall.ps1
    Prerequisite   : PowerShell 5.1 or higher, Administrator privileges
    Copyright      : XOAP.io
    
.EXAMPLE
    .\windows11-configure_Windows_Firewall.ps1
    Configures Windows Firewall with defaults
    
.EXAMPLE
    .\windows11-configure_Windows_Firewall.ps1 -EnableRDP -EnableWinRM
