...
.DESCRIPTION
    Regenerates the .NET native image cache using ngen.exe for Windows 10/11.
    Improves .NET application startup performance.

.NOTES
    File Name      : windows11-dotnet_regenerate_native_image_cache.ps1
    Prerequisite   : PowerShell 5.1 or higher, .NET Framework 4.0+
    Copyright      : XOAP.io
    
.EXAMPLE
    .\windows11-dotnet_regenerate_native_image_cache
