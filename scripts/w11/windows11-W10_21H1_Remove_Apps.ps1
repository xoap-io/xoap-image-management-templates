<#
.SYNOPSIS
    Remove Windows 10 21H1 Appx Packages

.DESCRIPTION
    Removes provisioned and installed Windows 10 Appx packages for clean imaging.
    Disables Microsoft Consumer Experience features.

.NOTES
    File Name      : windows11-W10_21H1_Remove_Apps.ps1
    Prerequisite   : PowerShell 5.1 or higher, Administrator privileges
    Copyright      : XOAP.io
    
.EXAMPLE
    .\windows11-W10_21H1_Remove_Apps.ps1
    Removes Windows 10 21H1 built-in apps
#>
