<#
.SYNOPSIS
    Cleans up temporary files, event logs, WinSxS, and more on Windows 10/11.

.DESCRIPTION
    This script removes temporary files, cleans event logs, runs CleanMgr, cleans WinSxS, and removes disabled features.
    Developed and optimized for use with the XOAP Scripted Actions module, but can be used independently.
    No liability is assumed for the function, use, or consequences of this freely available script.

.NOTES
    File Name      : windows11-Cleanup_Temporary_Files.ps1
...
.EXAMPLE
    .\windows11-Cleanup_Temporary_Files.ps1
...
try {
    ...
    Write-Log 'Running CleanMgr automation...'
    try {
