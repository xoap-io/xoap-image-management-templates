...
.DESCRIPTION
    Installs the Windows Package Manager (winget) on Windows 10/11 and client operating systems.
    Downloads and installs required dependencies including VCLibs and UI.Xaml frameworks.
    Compatible with Windows 10/11 2019+, Windows 10, and Windows 11.

.NOTES
    File Name      : windows11-install_winget.ps1
    Prerequisite   : PowerShell 5.1 or higher, Administrator privileges
    Copyright      : XOAP.io
    
.EXAMPLE
    .\windows11-install_winget.ps1
