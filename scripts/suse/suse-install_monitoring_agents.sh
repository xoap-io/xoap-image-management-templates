#!/bin/bash
#===================================================================================
# Script: install_monitoring_agents_suse.sh
# Description: Install monitoring agents for SUSE/openSUSE
# Author: XOAP Infrastructure Team
# Usage: ./install_monitoring_agents_suse.sh [--skip-node-exporter] [--skip-telegraf]
#===================================================================================
...
log_info "Starting monitoring agents installation for SUSE..."
...
baseurl=https://repos.influxdata.com/sles/$releasever/$basearch/stable/
enabled=1
gpgcheck=1
...
EOF
        ...
        # Install Telegraf
        if zypper refresh && zypper install -y telegraf; then
