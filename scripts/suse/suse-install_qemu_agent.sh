#!/bin/bash
#===================================================================================
# Script: install_qemu_agent_suse.sh
# Description: Install QEMU Guest Agent for SUSE/openSUSE
# Author: XOAP Infrastructure Team
# Usage: ./install_qemu_agent_suse.sh
#===================================================================================
...
log_info "Starting QEMU Guest Agent installation for SUSE..."
...
# Check if guest agent is communicating
log_info "Testing guest agent communication..."
...
log_info "Package version: $(rpm -q qemu-guest-agent --queryformat '%{VERSION}' 2>/dev/null || echo 'unknown')"
