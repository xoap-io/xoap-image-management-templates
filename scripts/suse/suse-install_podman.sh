#!/bin/bash
#===================================================================================
# Script: install_podman_suse.sh
# Description: Install Podman and buildah for SUSE/openSUSE
# Author: XOAP Infrastructure Team
# Usage: ./install_podman_suse.sh
#===================================================================================
...
log_info "Starting Podman installation for SUSE..."
...
# Create docker compatibility symlink (optional)
